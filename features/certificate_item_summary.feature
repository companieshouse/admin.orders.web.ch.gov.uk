Feature: Item summary for certified certificates
  ...
  Scenario: Certificate for active limited company
    ...
    Then The following item details should be displayed:
      ...
      | CRT-123456-123456 | COMPANY NAME LIMITED | 12345678       | Incorporation with all company name changes | Yes                        | Current address           | No                                         | No                                   | No              | Standard delivery (aim to dispatch within 10 working days) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom\n | Email only available for express delivery method | example@ch.gov.uk | £15 |
  ...
  Scenario: Certificate for administrated limited company
    ...
    Then The following item details should be displayed:
      ...
      | CRT-123456-123456 | COMPANY NAME LIMITED | 12345678       | Incorporation with all company name changes | Current address and the one previous | Yes                                        | Yes                                  | Yes             | Yes                     | Express (Orders received before 11am will be dispatched the same day. Orders received after 11am will be dispatched the next working day) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom\n | Yes                 | example@ch.gov.uk | £15 |
  ...
  Scenario: Certificate for dissolved limited company
    ...
    Then The following item details should be displayed:
      ...
      | CRT-123456-123456 | COMPANY NAME LIMITED | 12345678       | Dissolution with all company name changes | Standard delivery (aim to dispatch within 10 working days) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom\n | Email only available for express delivery method | example@ch.gov.uk | £15 |
  ...
  Scenario: Certificate for active LLP
    ...
    Then The following item details should be displayed:
      ...
      | CRT-123456-123456 | COMPANY NAME LIMITED | 12345678       | Incorporation with all company name changes | No                         | No                        | No                                          | No                               | Standard delivery (aim to dispatch within 10 working days) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom\n | Email only available for express delivery method | example@ch.gov.uk | £15 |
  ...
  Scenario: Certificate for administrated LLP
    ...
    Then The following item details should be displayed:
      ...
      | CRT-123456-123456 | COMPANY NAME LIMITED | 12345678       | Incorporation with all company name changes | Current address           | Yes                                         | Yes                              | Yes                     | Express (Orders received before 11am will be dispatched the same day. Orders received after 11am will be dispatched the next working day) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom\n | Yes                 | example@ch.gov.uk | £15 |
  ...
  Scenario: Certificate for active limited partnership
    ...
    Then The following item details should be displayed:
      ...
      | CRT-123456-123456 | COMPANY NAME LIMITED | 12345678       | Incorporation with all company name changes | Yes                        | Current address and the two previous | Yes                                       | Yes                                       | Yes                        | Standard delivery (aim to dispatch within 10 working days) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom\n | Email only available for express delivery method | example@ch.gov.uk | £15 |
