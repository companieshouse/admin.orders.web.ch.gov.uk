Feature: Orders search page
  ...
  Scenario: Search by criteria with multi-item basket enabled
    ...
    And   The following orders should be displayed:
      ...
      | ORD-121212-121212 | demo2@ch.gov.uk | 11/04/2022 | In progress    | false    |
      | ORD-323232-323232 | demo3@ch.gov.uk | 11/04/2022 | Paid           | false    |
      | ORD-321321-321321 | demo4@ch.gov.uk | 11/04/2022 | Paid           | false    |
