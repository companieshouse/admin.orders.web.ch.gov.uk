Feature: Orders search page
  ...
  Scenario: Search by criteria with multi-item basket enabled
    Given Multi-item basket functionality has been enabled
    And I have opened the search orders page
    And   I have entered search criteria for order number, email and company number
    And   Orders API will return results omitting company_number and product_line fields
    When  I click search
    Then  The search criteria should be preserved
    And   The following orders should be displayed:
      | Order number      | Email           | Order date | Payment status | Linkable |
      | ORD-123123-123123 | demo1@ch.gov.uk | 11/04/2022 | Paid           | true     |
      | ORD-121212-121212 | demo2@ch.gov.uk | 11/04/2022 | In progress    | true     |
      | ORD-323232-323232 | demo3@ch.gov.uk | 11/04/2022 | Paid           | true     |
      | ORD-321321-321321 | demo4@ch.gov.uk | 11/04/2022 | Paid           | true     |
