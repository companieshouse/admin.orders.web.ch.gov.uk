Feature: Item summary for certified copies
  ...
  Scenario: Certified copy with standard delivery
    ...
    Then The following item details should be displayed:
      | Item number       | Company name         | Company number | Dispatch method                                            | Delivery address                                                                               | Email address     |
      | CCD-123123-123123 | COMPANY NAME LIMITED | 12345678       | Standard (aim to send out within 10 working days) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom | example@ch.gov.uk |
  ...
  Scenario: Certified copy with express delivery
    ...
    Then The following item details should be displayed:
      | Item number       | Company name       | Company number | Dispatch method                                                                                                                           | Delivery address                                                                               | Email address     |
      | CCD-123123-123123 | OTHER NAME LIMITED | 12345679       | Express (Orders received before 11am will be sent out the same day. Orders received after 11am will be sent out the next working day) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom | example@ch.gov.uk |
    And The following document details should be displayed:
      | Date filed  | Type | Description                                                          | Fee |
  ...
  Scenario: Certified copy with unhandled filing history description
    ...
    Then The following item details should be displayed:
      | Item number       | Company name                   | Company number | Dispatch method                                            | Delivery address                                                                               | Email address     |
      | CCD-123123-123123 | UNHANDLED COMPANY NAME LIMITED | 12345670       | Standard (aim to send out within 10 working days) | bob bob\ncompany name\naddress line 1\naddress line 2\nlocal\nregion\npostcode\nUnited Kingdom | example@ch.gov.uk |
    And The following document details should be displayed:
      | Date filed  | Type | Description    | Fee |
